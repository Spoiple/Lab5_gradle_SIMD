...
Java_he1027_1lab5_AVX_1Contrast_sim4x(JNIEnv *env, jobject obj, jintArray arr, jintArray dstArr, jint window, jint level)
{
//    clock_t start, end;
...
//    printf("\n%d", len);
    ...
    for (int i = 0; i < len/8; i++) {
        pixel = _mm_load_si128( &array[i*4] );

        // Mask and set bits with value below level
        levelMask = _mm128_max_epu8( pixel, mLevel );
...
JNIEXPORT void JNICALL
Java_he1027_1lab5_AVX_1Contrast_simd8x(JNIEnv *env, jobject obj, jintArray arr, jintArray dstArr, jint window, jint level)
{
//    clock_t start, end;
//    double cpu_time_used;
//    start = clock();
